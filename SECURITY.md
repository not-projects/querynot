...
QueryNot `0.1.16` is the current public release for Windows 11 x86-64, Linux x86-64, macOS Intel, and macOS Apple silicon under one signed updater contract. Security fixes are applied on a best-effort basis to the current `master` branch and supported release line.
