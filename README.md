...
npm run release:validate-update-candidate -- --directory <candidate-dir> --tag v0.1.5 --report artifacts/candidate-validation.json
npm run release:prepare-update-publication -- --directory <candidate-dir> --output artifacts/publication --tag v0.1.5 --confirm publish-v0.1.5 --report artifacts/publication-plan.json
```
