...
npm run release:prepare-update-publication -- --directory <candidate-dir> --output artifacts/publication --tag v0.1.4 --confirm publish-v0.1.4 --report artifacts/publication-plan.json
```
