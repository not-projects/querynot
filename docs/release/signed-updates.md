...
The current completed signed release is `v0.1.11`: candidate run [`33067804227`](https://github.com/not-projects/querynot/actions/runs/33067804227), publication run [`33069003334`](https://github.com/not-projects/querynot/actions/runs/33069003334), source commit `dc661c15cf0c77bd904e6d3ed4c963bf2b620ebc`, and release [`v0.1.11`](https://github.com/not-projects/querynot/releases/tag/v0.1.11). Routine exact-candidate, updater-signature, draft/public GitHub asset-metadata, and bounded endpoint-smoke gates passed; the optional full-package public deep audit was intentionally not run for this fast patch shipment.
