...
The current completed signed release is `v0.1.9`: candidate run [`32983327124`](https://github.com/not-projects/querynot/actions/runs/32983327124), publication run [`33006398204`](https://github.com/not-projects/querynot/actions/runs/33006398204), source commit `753bb44ce099694fdde931ca97f18cf1ec7c84cb`, and release [`v0.1.9`](https://github.com/not-projects/querynot/releases/tag/v0.1.9). Initial publication run `32984439036` remained unassigned during the 2026-08-26 GitHub Actions incident and created no draft, tag, or asset; the unchanged recovery run published the reviewed candidate after service recovery.
