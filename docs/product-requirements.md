...
- Windows 10 and Linux ARM remain outside the `0.1.13` support and distribution claim. Portable compile checks and historical WSL2/Linux engineering packages are development evidence only.
